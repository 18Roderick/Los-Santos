...
<div class="container">
  ...
  <div class="row card">
    ...
    <img class="img-fluid" src="./public/images/ciudad-de-panam-antigua.png" alt="Ciudad de Los Santos">
    
    <br><br>
    <div class="col-sm-12 col-md-12 etapas">
      <h4 target="#precolombina" onclick="mostrar('#precolombina')"><b>
      Época precolombina
        
      </b></h4>

      <p class="texto collapse" id="precolombina">
    ...
    <div class="col-sm-12 etapas">
      ...
      <h4 onclick="mostrar('#colonial')"><b>
        Época colonial
      </b></h4>

      <p class="texto collapse" id="colonial">
    ...
    <div class="col-sm-12 col-md-12 etapas">
      <h4 onclick="mostrar('#republicana')"><b>
        Época Republicana
      </b></h4>

      <p class="texto collapse" id="republicana">
