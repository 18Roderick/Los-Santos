   ...
   if (isset($_REQUEST['id'])) {
    ...
    switch ($id) {
      case 1:
        print('
        <br>
        <div class="col-sm-12 col-md-12 precolombina">
          ...
          <div class="contenedor">
            ...
            <a href="./historia.php" class="btn btn-primary">volver</a>
            <a href="./historia.php?id=2" class="btn btn-primary">siguiente</a>
          </div>
        ...
        <div class="col-sm-12 colonial">
          ...
          <div class="contenedor">
            ...
            esta población que se inicia el repoblamiento de la península de Azuero,
              ...
              Este suceso se conoce con el nombre de El Grito de Los Santos. Con la independencia 
              de Panamá y su posterior adhesión a la Gran Colombia, la jurisdicción administrativa 
              ...
              denominados Estado de Venezuela y Estado del Ecuador.En 1855, Panamá, 
              pasó a convertirse en Estado Federal de Panamá, constituido por las provincias 
              de Panamá, Azuero, Veraguas y Chiriquí. A través de la Ley de 12 de septiembre 
              de 1855, se instauró el departamento de Los Santos.
            
            </p>
            <a href="./historia.php" class="btn btn-primary">volver</a>
            <a href="./historia.php?id=3" class="btn btn-primary">siguiente</a>
          </div>
      ...
      case 3:
        print('
        <br>
        <div class="col-sm-12 col-md-12 republicana">
        <div class="contenedor">
            <h4 ><b>
            Época Republicana
          </b></h4>
          ...
          <a href="./historia.php" class="btn btn-primary">volver</a>
          <a href="./personajes.php" class="btn btn-primary">siguiente</a>
        </div>
      </div>
      ...
      default:
        ...
        <img class="card-img-top" height="150px" src="./public/images/Antecedentes/precolombina.png" alt="Card image cap">
          <div class="card-body">
        ...
        <div class="card col-sm-12 col-md-3" style="width: 18rem;">
        <img class="card-img-top" height="150px" src="./public/images/Antecedentes/colonial.png" alt="Card image cap">
          <div class="card-body">
        ...
        <div class="card col-sm-12 col-md-3" style="width: 18rem;">
        <img class="card-img-top" height="150px" src="./public/images/Antecedentes/republicana.png" alt="Card image cap">
          <div class="card-body">
        ...
        <div class="card col-sm-12 col-md-3" style="width: 18rem;">
        <img class="card-img-top" height="150px" src="./public/images/Antecedentes/collagePersonajes.jpeg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Personajes importantes</h5>
            <p class="card-text">
            </p>
            <a href="./personajes.php" class="btn btn-primary">ver mas</a>
          </div>
        </div>
